...
class RegisterPage extends React.Component {
    ...
    handleSubmit(event) {
        ...
        if (user.firstName && user.lastName && user.username && user.password && user.age && user.gender && user.email && user.phone) {
            ...
            <div className="col-md-6 col-md-offset-3">
                ...
                <form name="form" onSubmit={this.handleSubmit}>
                    ...
                    <div className={'form-group' + (submitted && !user.age ? ' has-error' : '')}>
                        ...
                        <input type="number" className="form-control" name="age" value={user.age} onChange={this.handleChange} />
                        {submitted && !user.age &&
